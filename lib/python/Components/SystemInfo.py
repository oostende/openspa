...
SystemInfo["LCDSKINSetup"] = path.exists("/usr/share/enigma2/display") and getBoxType() in ('et8500', 'et10000', 'gb800ue', 'gb800ueplus', 'gbquad', 'gbquadplus', 'gbultraue', 'vuduo2') and not fileExists("/etc/enigma2/skin_user.xml")
