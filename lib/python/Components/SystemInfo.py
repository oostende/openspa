...
SystemInfo["LCDSKINSetup"] = path.exists("/usr/share/enigma2/display") and getBoxType() in ('et8500', 'et10000', 'gb800ue', 'gb800ueplus', 'gbquad', 'gbquadplus', 'gbultraue') and not fileExists("/etc/enigma2/skin_user.xml")
